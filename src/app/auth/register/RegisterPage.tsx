            ...
            <div className=" flex w-full  bg-[#2F333E]  justify-center items-center    " style={{ height: '100vh' }}>
                <div className=" flex w-[1366px] h-[768px]  justify-between  ">
                    <div className='flex-col w-full  '>
                        ...
                        <p className='mb-12' style={{ fontSize: '25px', fontFamily: 'Chillax-Bold', color: 'white' }} >Register  to <span style={{ color: '#D98C07' }}>PAWA.</span></p>
                        ...
                        <div>
                            <div  className=' mb-6 flex  items-center w-[395px] gap-3' style={{border:'1px solid white', padding:'1em', borderRadius:'6px'}}>
                                ...
                                <input type="text" placeholder='Your First Name' style={{background:'none',fontSize:'15px'}} />
                            </div>
                        </div>
                        <div>
                            <div  className=' mb-6 flex  items-center w-[395px] gap-3' style={{border:'1px solid white', padding:'1em', borderRadius:'6px'}}>
                                <img src="/assets/password-icon.png" height={'22px'} width={'22px'} alt="" />
                                <input type="text" placeholder='Your Last Name' style={{background:'none',fontSize:'15px'}} />
                            </div>
                        </div>
                        ...
                        <div>
                            <button style={{width:'397px',color:'white',backgroundColor:'#D98C07',padding:'1em', borderRadius:'5px', fontSize:'16px', fontFamily:'Avenir-Heavy'}}>Sign In</button>
                        </div>
