...
//         </div>
//       <div className="flex-1  h-[764px]  bg-[url('/assets/spacecraft.png')] bg-cover bg-center  flex items-center justify-between   " style={{backgroundSize: '80%'}}>
...
//       <div className="flex  justify-center items-center z-20 w-full h-[764px]   " style={{position:'absolute',top:0}}>
//             <div className="flex-1 bg-[#2F333E] h-[764px] flex-col  " style={{paddingTop:'10em',paddingLeft:'16em'}}>
//                 <div className="flex">
...
//             </div>
//             <div className="flex-1  h-[764px] flex items-center justify-center">
    ...
    return (
        <>
            <div className="flex justify-center items-center h-[764px] bg-[#2F333E]  ">
                ...
                <div style={headerStyle} className="w-[1366px]  h-[764px]  flex items-center justify-center">
