  ...
  return (
    ...
    <div className="mt-100 flex w-full h-[400px] bg-[#2F333E]  justify-center items-start mt-20 "> 
            <div className="w-[1366px] h-[400px]  flex items-center justify-between  ">
                    <div>
                        <img src="/assets/pawa-footer-logo.png" height={80} width={78} alt="" />
                        ...
                        <div className="flex gap-6  mt-8">
                                <div className="flex justify-center items-center"  style={{borderRadius:'100%',backgroundColor:'#FF3600', height:'42px', width:'42px'}}>
                                    <img src="/assets/facebook-logo.png" width={'9px'} alt="" />
                                </div>
                                <div className="flex justify-center items-center"  style={{borderRadius:'100%',backgroundColor:'#FF3600', height:'42px', width:'42px'}}>
                                    <img src="/assets/x-logo.png" width={'17px'} alt="" />
                                </div>
                               
                                <div className="flex justify-center items-center"  style={{borderRadius:'100%',backgroundColor:'#FF3600', height:'42px', width:'42px'}}>
                                    <img src="/assets/linkedin-logo.png" width={'17px'} alt="" />
                                </div>
                                <div className="flex justify-center items-center"  style={{borderRadius:'100%',backgroundColor:'#FF3600', height:'42px', width:'42px'}}>
                                    <img src="/assets/instagram-logo.png" width={'17px'} alt="" />
                                </div>
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div>
                            <div className="w-[323px] h-[47px] bg-[#D9D9D9]/30 rounded-lg flex justify-between items-center mt-10" >
                                ...
                                <div className="h-full flex justify-center  items-center p-3" style={{backgroundColor:'white ', borderTopRightRadius:'5px',borderBottomRightRadius:'5px'}}><img src="/assets/pawa-logo-tilted.png" width={24} height={24} alt="" /></div>
                            </div>
                        </div>
