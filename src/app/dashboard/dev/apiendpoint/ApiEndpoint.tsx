    ...
    <div className="flex w-full bg-red-500 " style={{ height: '100vh' }}>
      ...
      <div className="flex flex-col items-center  w-full bg-[#2F2D2D]">
        ...
        <div className=" h-[100vh]  w-full flex flex-col justify-between items-center pb-3  ">
          ...
          <div className="flex rounded-[5px]  flex-col bg-[#525050] w-[864px]   " style={{borderLeft:'7px solid #17A57E' ,borderTop:'1px solid #7D7B7B', borderBottom:'1px solid #7D7B7B'}}>
                  <div className="flex h-[483px] lex-row justify-between items-center ">
                        <p>GET</p>
                  </div>
